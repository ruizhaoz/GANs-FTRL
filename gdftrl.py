...
class gdftrl(optimizer.Optimizer):
    def __init__(self, learning_rate=0.001, beta1=0.9, beta2=0.999, epsilon=1e-8,
                 use_locking=False, name="gdftrl"):
        super(gdftrl, self).__init__(use_locking, name)
    ...
    def _apply_dense(self, grad, var):
        ...
        with ops.control_dependencies([var_update]):
            ...
            v_t = state_ops.assign(v,1,use_locking=self._use_locking)

        var_update = state_ops.assign_sub(var,2 * lr * m_t,use_locking=self._use_locking)
